            ...
            movieDetails.length === 0
              ? <>
                ...
                <div className='mt-2 md:mt-6 lg:flex lg:flex-row transition-all'>
                  <div className='animate-pulse bg-zinc-800 h-[200px] md:h-[350px] lg:h-[250px] basis-1/2' />
              ...
              : <>
                ...
                <div className='mt-2 md:mt-6 transition-all'>
                  <div className='lg:flex lg:flex-row transition-all'>
                    <div className='basis-1/2 max-h-[200px] md:max-h-[350px] lg:max-h-[250px] transition-all'>
                      <Image
                        draggable="false"
